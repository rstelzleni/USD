...
HydraPassthroughExtCompPrimvarBufferSource::HydraPassthroughExtCompPrimvarBufferSource(
...
HydraPassthroughExtCompPrimvarBufferSource::~HydraPassthroughExtCompPrimvarBufferSource() = default;

TfToken const &
HydraPassthroughExtCompPrimvarBufferSource::GetName() const
{
    return _primvarName;
}

void
HydraPassthroughExtCompPrimvarBufferSource::GetBufferSpecs(HdBufferSpecVector *specs) const
{
    specs->emplace_back(_primvarName, _tupleType);
}

template <class HashState>
void TfHashAppend(HashState &h, HydraPassthroughExtCompPrimvarBufferSource const &bs)
{
...
size_t
HydraPassthroughExtCompPrimvarBufferSource::ComputeHash() const
{
    return TfHash()(*this);
}

bool
HydraPassthroughExtCompPrimvarBufferSource::Resolve()
{
...
void const *
HydraPassthroughExtCompPrimvarBufferSource::GetData() const
{
    return _rawDataPtr;
}

HdTupleType
HydraPassthroughExtCompPrimvarBufferSource::GetTupleType() const
{
    return _tupleType;
}

size_t
HydraPassthroughExtCompPrimvarBufferSource::GetNumElements() const
{
    return _source->GetNumElements();
}

bool
HydraPassthroughExtCompPrimvarBufferSource::_CheckValid() const
{
    return (_source &&
            (_sourceOutputIdx !=
