#ifndef PXR_USD_IMAGING_HYDRA_PASSTHROUGH_TRIANGULATE_H
#define PXR_USD_IMAGING_HYDRA_PASSTHROUGH_TRIANGULATE_H
...
/// \class HydraPassthroughTriangleIndexBuilderComputation
///
...
class HydraPassthroughTriangleIndexBuilderComputation : public HdComputedBufferSource {
public:
    HydraPassthroughTriangleIndexBuilderComputation(
...
/// \class HydraPassthroughTriangulateFaceVaryingComputation
///
/// CPU face-varying triangulation.
///
class HydraPassthroughTriangulateFaceVaryingComputation : public HdComputedBufferSource {
public:
    HydraPassthroughTriangulateFaceVaryingComputation(
            HydraPassthroughMeshTopology *topologoy,
...
#endif // PXR_USD_IMAGING_HYDRA_PASSTHROUGH_TRIANGULATE_H
